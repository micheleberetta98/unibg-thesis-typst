...
#let translations = (
  ...
  coadvisors:      (it: "Correlatori",                   en: "Co-advisors"),
...
#let master-front-page(
  ...
  authors,
      ...
      #if coadvisors != none {
        v(0.5cm)
        if coadvisors.len() == 1 or type(coadvisors) == str [
          #tr("coadvisor")
          #par(coadvisors)
        ] else [
          #tr("coadvisors")
...
#let unibg(
  ...
  if deg == "master" {
    master-front-page(title, subtitle, degree, advisor, coadvisors, authors)
  } else if deg == "bachelor" {
    bachelor-front-page(title, subtitle, degree, advisor, coadvisors, authors)
  }
